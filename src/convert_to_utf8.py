...
convert_to_utf8 = open(
    '/Users/Love/Documents/GitHub/msds510/data/raw/avengers.csv', 'rb')
...
F = open('/Users/Love/Documents/GitHub/msds510/data/interim/avengers_utf8.csv',
         'r')
lines = F.readlines()
print(lines)
